...
@Component({
  selector: 'app-sat-position',
  template: `
    <div class="sat-panel sat-position">
      <h2 class="tab-title">Current Position</h2>
      <div *ngIf="satIndex!=null; else noSat" class="content">
        <div class="placeholder-note">(Lat/Lon/Alt + velocidad + proyección ground track – próximamente)</div>
      </div>
...
export class SatPositionComponent { @Input() satIndex: number | null = null; }
